...
class AppTheme {
  ...
  static const TextStyle title = TextStyle(fontSize: 26, fontWeight: FontWeight.w500, color: Colors.white);
  static const TextStyle subtitle = TextStyle(fontSize: 16, color: Colors.white60, fontWeight: FontWeight.w400);
  static const TextStyle buttonTitle = TextStyle(fontSize: 15, fontWeight: FontWeight.bold);
  static const TextStyle forecastLabel = TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.white60);
  static const TextStyle forecastTemp = TextStyle(fontSize: 14, fontWeight: FontWeight.bold);
  static const TextStyle forecastStatus = TextStyle(fontSize: 11, color: Colors.white70, fontWeight: FontWeight.w400);
}
